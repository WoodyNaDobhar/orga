...
return new class extends Migration
{
	...
	public function up()
	{
		...
		Schema::create('titles', function (Blueprint $table) {
			...
			$table->enum('peerage', ['Gentry', 'Knight', 'Master', 'Nobility', 'None', 'Paragon', 'Retainer', 'Squire'])->default('None')->comment('The peerage (default None) of the Title; Gentry, Knight, Master, Nobility, None, Paragon, Retainer, or Squire');
