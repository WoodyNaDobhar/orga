...
// 			$this->authorize('viewAny', Crat::class);
	...
	/**
	 * @param CreateCratAPIRequest $request
	 * @return Response
	 *
	 * @OA\Post(
	 *		path="/crats",
	...
	public function store(CreateCratAPIRequest $request): JsonResponse
	{
		try {
			...
			$this->authorize('create', Crat::class);
...
// 			$this->authorize('view', $crat);
	...
	/**
	 * @param int $id
	 * @param UpdateCratAPIRequest $request
	 * @return Response
	 *
	 * @OA\Post(
	 *		path="/crats/{id}",
	...
	public function destroy($id): JsonResponse
	{
		try {
			...
			if (empty($crat)) {
				return $this->sendError('Crat (' . $id . ') not found.', ['id' => $id], 404);
			}
		
			$this->authorize('delete', $crat);
