...
const imageAssets = import.meta.glob<{
    default: string;
}>("/resources/@client/assets/images/fakers/*.{jpg,jpeg,png,svg}", {
    eager: true,
});
                ...
                },
                {
                    ...
                    <div class="w-10 h-10 intro-x image-fit">
                      <img alt="Midone Tailwind HTML Admin Template" class="rounded-full shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]" src="${
                          imageAssets[
                              "/resources/@client/assets/images/fakers/" +
                                  response.images[0]
                          ].default
                      }">
                    </div>
        ...
        <div class="flex w-full mt-4 sm:w-auto sm:mt-0">
            ...
            <Menu class="ml-auto sm:ml-0">
                ...
                <Menu.Items class="w-40">
                    <Menu.Item>
                        <Lucide icon="FilePlus" class="w-4 h-4 mr-2" /> New
                        Category
                    </Menu.Item>
                    <Menu.Item>
                        <Lucide icon="UserPlus" class="w-4 h-4 mr-2" /> New
                        Group
                    </Menu.Item>
                </Menu.Items>
            </Menu>
