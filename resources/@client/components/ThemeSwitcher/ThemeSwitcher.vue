...
<template>
    <div>
                    ...
                    <div class="flex flex-col">
                      ...
                      switchTheme(theme)
                                    ...
                                    >
                                        ...
                                        >
                                            <img
                                                ...
                                                :src="
                                                    themeImages[
                                                        '/resources/@client/assets/images/themes/' +
                                                            theme +
                                                            '.png'
                                                    ].default
                                                "
                        ...
                        <div class="px-8 pt-6 pb-8">
                            ...
                            <div
                                class="mt-5 grid grid-cols-3 gap-x-5 gap-y-3.5"
                            >
                                    ...
                                    >
                                        ...
                                        >
                                            <img
                                                ...
                                                :src="
                                                    layoutImages[
                                                        '/resources/@client/assets/images/layouts/' +
                                                            layout +
                                                            '.png'
                                                    ].default
                                                "
                      ...
                      switchColorScheme(colorScheme)
                                        ...
                                        :class="[
                                            ...
                                            colorSchemeStore.colorSchemeValue ==
                                            colorScheme
                                                ? 'active'
                                                : '',
                                        ]"
                                    >
                                        ...
                                        >
                                            <div
                                                class="flex items-center h-full gap-1 -mx-2"
                                            >
                                                <div
                                                    :class="[
        ...
        <div
            ...
            style="margin-bottom: 95px; margin-right: 10px;"
            @click="(event: MouseEvent) => {
        event.preventDefault();
