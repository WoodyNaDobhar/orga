import{P as s}from"./index-BdeQ4DVD.js";import{d as D,r as p,c as M,a as t,b as e,w as a,u as l,F,o as B,B as n,e as r,t as f,_ as h,L as m,T as _}from"./main-ClcOOv-T.js";import{_ as g}from"./FormLabel.vue_vue_type_script_setup_true_lang-CMIw5nM8.js";import{_ as c}from"./Litepicker.vue_vue_type_script_setup_true_lang-Br2WRQ7_.js";import{_ as w}from"./Button.vue_vue_type_script_setup_true_lang-k6tThAl7.js";const C=t("div",{class:"flex items-center mt-8 intro-y"},[t("h2",{class:"mr-auto text-lg font-medium"},"Datepicker")],-1),N={class:"grid grid-cols-12 gap-6 mt-5 intro-y"},P={class:"col-span-12 lg:col-span-6"},Y={class:"flex flex-col items-center p-5 border-b sm:flex-row border-slate-200/60 dark:border-darkmode-400"},L=t("h2",{class:"mr-auto text-base font-medium"},"Basic Date Picker",-1),V={class:"p-5"},I={class:"flex flex-col items-center p-5 border-b sm:flex-row border-slate-200/60 dark:border-darkmode-400"},E=t("h2",{class:"mr-auto text-base font-medium"},"Input Group",-1),S={class:"p-5"},A={class:"relative w-56 mx-auto"},T={class:"absolute flex items-center justify-center w-10 h-full border rounded-l bg-slate-100 text-slate-500 dark:bg-darkmode-700 dark:border-darkmode-800 dark:text-slate-400"},W={class:"col-span-12 lg:col-span-6"},H={class:"flex flex-col items-center p-5 border-b sm:flex-row border-slate-200/60 dark:border-darkmode-400"},G=t("h2",{class:"mr-auto text-base font-medium"},"Date Range Picker",-1),R={class:"p-5"},U={class:"flex flex-col items-center p-5 border-b sm:flex-row border-slate-200/60 dark:border-darkmode-400"},O=t("h2",{class:"mr-auto text-base font-medium"},"Modal Date Picker",-1),$={class:"p-5"},j={class:"text-center"},z=t("h2",{class:"mr-auto text-base font-medium"},"Filter by Date",-1),q={class:"col-span-12 sm:col-span-6"},J={class:"col-span-12 sm:col-span-6"},ae=D({__name:"Datepicker",setup(K){const u=p(""),k=p(""),x=p(!1),b=y=>{x.value=y},v=p(null);return(y,o)=>(B(),M(F,null,[C,t("div",N,[t("div",P,[e(l(s),{class:"intro-y box"},{default:a(({toggle:i})=>[t("div",Y,[L,e(l(n),{class:"w-full mt-3 sm:w-auto sm:ml-auto sm:mt-0"},{default:a(()=>[e(l(n).Label,{htmlFor:"show-example-1"},{default:a(()=>[r(" Show example code ")]),_:1}),e(l(n).Input,{id:"show-example-1",onClick:i,class:"ml-3 mr-0",type:"checkbox"},null,8,["onClick"])]),_:2},1024)]),t("div",V,[e(l(s).Panel,null,{default:a(()=>[e(l(c),{modelValue:u.value,"onUpdate:modelValue":o[0]||(o[0]=d=>u.value=d),options:{autoApply:!1,showWeekNumbers:!0,dropdowns:{minYear:1990,maxYear:null,months:!0,years:!0}},class:"block w-56 mx-auto"},null,8,["modelValue"])]),_:1}),e(l(s).Panel,{type:"source"},{default:a(()=>[e(l(s).Highlight,null,{default:a(()=>[r(f(`
              <Litepicker
                v-model="date"
                :options="{
                  autoApply: false,
